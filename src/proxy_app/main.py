...
with _console.status("[dim]Loading LiteLLM library...", spinner="dots"):
    ...
    # Monkey-patch litellm's raise_on_model_repetition to guard against empty choices
    # Some providers (e.g. MiniMax M2.7 via OpenCode Go) return chunks with choices=[]
    # which causes IndexError: list index out of range in the original code.
