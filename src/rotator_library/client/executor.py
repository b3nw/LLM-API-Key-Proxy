...
class RequestExecutor:
    ...
    async def _resolve_litellm_client(
        ...
        Args:
            base_url: The API base URL to use. When provided, the client's
                base_url is set so requests go to the correct endpoint
                instead of defaulting to api.openai.com.

        Returns None when no proxy applies to this credential.
        """
