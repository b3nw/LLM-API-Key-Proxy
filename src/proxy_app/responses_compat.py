...
class ResponsesStreamConverter:
    ...
    def _finalize(self) -> str:
        ...
        # Finalize reasoning summary
        if self.reasoning_started:
            reasoning_output_index = self.reasoning_output_index
            if reasoning_output_index is None:
                reasoning_output_index = self._allocate_output_index()
                self.reasoning_output_index = reasoning_output_index
            ...
            output_items_by_index.append((reasoning_output_index, reasoning_item))
        ...
        if self.content_started:
            ...
            if message_output_index is None:
                message_output_index = self._allocate_output_index()
                self.output_index = message_output_index
        ...
        output_items = [
            item for _, item in sorted(output_items_by_index, key=lambda item: item[0])
        ]
