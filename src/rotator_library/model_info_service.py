...
def _strip_infra_suffix(name: str) -> str:
    """
    Strip a single trailing infrastructure suffix from a model name.

    Returns the stripped name, or the original if no suffix matched.
    ...
    """
    return _INFRA_SUFFIX_RE.sub("", name)
