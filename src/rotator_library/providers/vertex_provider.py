...
class VertexProvider(ProviderInterface):
    ...
    Environment variables:
        ...
        VERTEX_API_KEY_N - API keys (standard rotation pattern)
    ...
    def __init__(self):
        ...
        if not self.project:
            raise ValueError(
                ...
                "for the Vertex Express provider"
            )

        # Build base URL for the OpenAI-compatible endpoint
        ...
        lib_logger.info(
            f"VertexProvider initialized: project={self.project}, "
            f"location={self.location}, base={self.api_base}"
        )
    ...
    async def get_models(self, api_key: str, client: httpx.AsyncClient) -> List[str]:
        ...
        try:
            ...
            for model_info in data.get("models", []):
                ...
                if model_name.startswith(("gemini-", "gemma-4")):
