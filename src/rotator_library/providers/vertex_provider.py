...
class VertexProvider(ProviderInterface):
    ...
    async def acompletion(
        ...
        #   1. top-level kwargs["thinking"]  (set by client or transforms)
        #   2. default: enable with include_thoughts for thinking-capable models
        ...
        _is_thinking_model = any(
            p in model
            for p in ("gemini-2.5-pro", "gemini-2.5-flash",
                       "gemini-3", "gemini-3.1")
        )
