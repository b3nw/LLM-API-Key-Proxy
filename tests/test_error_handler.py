...
class TestClassifyError:
    ...
    def test_codex_stream_overload_is_server_error(self):
        """Codex stream overload events are transient server errors, not invalid requests."""
        from rotator_library.core.errors import StreamedAPIError
        from rotator_library.error_handler import should_retry_same_key
        ...
        result = classify_error(err, provider="codex")
