"""
Retired Cursor Provider with Quota Tracking

This module is archived for historical reference only. The Cursor provider is no
longer registered, discovered, or exposed by the proxy. Do not import or rewire
this module into active runtime paths unless Cursor is deliberately un-retired.
...
from .cursor_quota_tracker import CursorQuotaTracker
